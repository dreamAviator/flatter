...
class SongListFilterable extends StatelessWidget {
  const SongListFilterable({super.key,required this.riverpodManager,required this.listView,required this.sliver});
